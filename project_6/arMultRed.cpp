...
main( int argc, char *argv[ ] )
{
	...
	fprintf(dataFile, "%lf", (double)NUM_ELEMENTS/(time1-time0)/1000000. );
	fclose(dataFile);

	printf("Global Work Size:%9d Local Work Size:%4d Work Grp Size:%8d\n", NUM_ELEMENTS, LOCAL_SIZE, NUM_ELEMENTS/LOCAL_SIZE );
